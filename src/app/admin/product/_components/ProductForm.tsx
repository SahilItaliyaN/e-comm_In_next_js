...
export default function ProductForm({product}:{product?:Product | null}) {
    ...
    return (
        ...
        <div className="space-y-2">
            ...
            <Input type="number" name="priceInCents" id="priceInCents" 
                required 
                value={priceInCents} 
        ...
        <div className="space-y-2">
            ...
            <Textarea id="description" name="description" required defaultValue={product?.name || ""} />
        ...
        <div className="space-y-2">
            ...
            {error.file && <div className="text-destructive">{error.priceInCents}</div>}
        </div>
        <div className="space-y-2">
